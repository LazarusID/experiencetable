...
int main(void) {
    describe("Plain Text ExperienceEvent", [] {
        ...
        it("should populate event and leave reason empty when reading from input stream", [] {
        ...
        it("should leave values in place if stream has ended", [] {
            stringstream src;
            ...
            expect(e.reason).toBe(string("Because he's harry"));
        });
    });

    describe("CSV ExperienceEvent", [] {
